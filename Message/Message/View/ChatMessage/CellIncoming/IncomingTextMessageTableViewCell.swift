...
class IncomingTextMessageTableViewCell: UITableViewCell {
    ...
    func setMessageDetailAttributedText(){
        ...
        let attributedText = NSMutableAttributedString(string:"\(data.sentBy ?? "")" , attributes:[NSAttributedString.Key.font: UIFont(name:CustomFont.poppinsMedium, size: 12)!,NSAttributedString.Key.foregroundColor: UIColor.darkGray])
        
        attributedText.append(NSAttributedString(string: "  \(data.time ?? "")" , attributes:[NSAttributedString.Key.font: UIFont(name:CustomFont.poppinsMedium, size: 12)!, NSAttributedString.Key.foregroundColor: UIColor.lightGray]))
